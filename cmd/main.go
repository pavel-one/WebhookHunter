...
func main() {
	...
	app.AdminRouteWithMiddleware("/requests/{slug}/{channel}/", "GET", adminRequestController.GetAllByChannel)
	app.AdminRouteWithMiddleware("/requests/", "GET", adminRequestController.GetAll)
	app.AdminRouteWithMiddleware("/request/{slug}/{channel}/{id}/", "PATCH", adminRequestController.Update)
	app.AdminRouteWithMiddleware("/request/{id}/", "DELETE", adminRequestController.Delete)
