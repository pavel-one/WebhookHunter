...
func main() {
	...
	app.AdminRouteWithMiddleware("/hunter/{slug}/get/", "GET", adminHunterController.Get)
	app.AdminRouteWithMiddleware("/hunters/get/", "GET", adminHunterController.GetAll)
	...
	app.AdminRouteWithMiddleware("/channel/{slug}/{channel}/get/", "GET", adminChannelController.Get)
	app.AdminRouteWithMiddleware("/channels/{slug}/get/", "GET", adminChannelController.GetAllByHunter)
	app.AdminRouteWithMiddleware("/channels/get/", "GET", adminChannelController.GetAll)
	app.AdminRouteWithMiddleware("/channel/{slug}/{channel}/get/", "PATCH", adminChannelController.Update)
	app.AdminRouteWithMiddleware("/channel/{slug}/{channel}/delete/", "DELETE", adminChannelController.Delete)
	////request
	adminRequestController := new(adminApi.AdminRequestController)
	adminRequestController.Init(app.DB)
	app.AdminRouteWithMiddleware("/request/{slug}/{channel}/create/", "POST", adminRequestController.Create)
	app.AdminRouteWithMiddleware("/request/{id}/get/", "GET", adminRequestController.Get)
	app.AdminRouteWithMiddleware("/requests/{slug}/{channel}/get/", "GET", adminRequestController.GetAllByChannel)
	app.AdminRouteWithMiddleware("/requests/get/", "GET", adminRequestController.GetAll)
	app.AdminRouteWithMiddleware("/request/{slug}/{channel}/{id}/update/", "PATCH", adminRequestController.Update)
	app.AdminRouteWithMiddleware("/request/{id}/delete/", "DELETE", adminRequestController.Delete)
